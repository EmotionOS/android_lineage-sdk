...
public class LineageVersionPreference extends SelfRemovingPreference
    ...
    private static final String KEY_EMOTION_VERSION_PROP = "ro.emotion.version";
    ...
    public void onAttached() {
        ...
        setTitle(R.string.emotion_version);
        setSummary(SystemProperties.get(KEY_EMOTION_VERSION_PROP,
